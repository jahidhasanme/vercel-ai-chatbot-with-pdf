        ...
        try {
          ...
          if (contentLength > 10 * 1000000) {
            ...
            const { data } = await axios.post(
              "https://codex4learner.com/api/convert-large-pdf-to-text",
              {
                pdfUrl,
              }
            );
            ...
            // 3 * 1000000 = 3MB
            const { data } = await axios.post(
              "https://codex4learner.com/api/convert-pdf-to-text",
              {
                pdfUrl,
              }
            );
            ...
            // 1000000 = 1MB
            const { data } = await axios.post(
              "https://codex4learner.com/api/convert-pdf-to-markdown",
              {
                pdfUrl,
              }
            );
